...
export interface ApiAuditAudit extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    auditDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::audit.audit'> &
      Schema.Attribute.Private;
    newValue: Schema.Attribute.Text & Schema.Attribute.Required;
    oldValue: Schema.Attribute.Text & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    standards: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiStandardCommentStandardComment
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateCreated: Schema.Attribute.DateTime & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    userId: Schema.Attribute.Relation<'oneToOne', 'admin::user'>;
  };
}

export interface ApiStandardVersionHistoryStandardVersionHistory
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    detailsOfChange: Schema.Attribute.Text & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::standard-version-history.standard-version-history'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    standard: Schema.Attribute.Relation<'oneToOne', 'api::standard.standard'>;
    ...
    versionNumber: Schema.Attribute.Decimal & Schema.Attribute.Required;
  };
}
...
export interface ApiStandardStandard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    approvedProducts: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    >;
    ...
    exceptions: Schema.Attribute.Relation<
      ...
      'api::exception.exception'
    >;
    firstPublished: Schema.Attribute.DateTime;
    governance: Schema.Attribute.RichText;
    ...
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    toleratedProducts: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    Administrator: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    firstName: Schema.Attribute.String;
    JobRole: Schema.Attribute.String;
    lastName: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::standard-version-history.standard-version-history': ApiStandardVersionHistoryStandardVersionHistory;
